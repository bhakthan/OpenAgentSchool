...
interface PromptChainingAudioControlsProps {
  componentName: string;
  className?: string;
  activeTab?: string;
}

export default function PromptChainingAudioControls({ 
  componentName, 
  className = '',
  activeTab = 'flow-diagram'
}: PromptChainingAudioControlsProps) {
  ...
  return (
    <TooltipProvider>
      <div className={`flex items-center gap-3 flex-wrap ${className}`}>
        ...
        {isPlaying && (
          <div className="flex items-center gap-2 p-1 bg-purple-50 dark:bg-purple-950 rounded border border-purple-200 dark:border-purple-800 flex-shrink-0">
            <div className="w-2 h-2 bg-purple-500 rounded-full animate-pulse"></div>
            <span className="text-xs font-medium text-purple-900 dark:text-purple-100 whitespace-nowrap">
