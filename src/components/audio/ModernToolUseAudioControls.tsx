...
interface ModernToolUseAudioControlsProps {
  componentName: string;
  className?: string;
  activeTab?: string;
}

export default function ModernToolUseAudioControls({ 
  componentName, 
  className = '',
  activeTab = 'flow-diagram'
}: ModernToolUseAudioControlsProps) {
  ...
  <div className="flex gap-1 flex-wrap">
        ...
        {isPlaying && (
          <div className="flex items-center gap-2 p-1 bg-orange-50 dark:bg-orange-950 rounded border border-orange-200 dark:border-orange-800 flex-shrink-0">
            <div className="w-2 h-2 bg-orange-500 rounded-full animate-pulse"></div>
            <span className="text-xs font-medium text-orange-900 dark:text-orange-100 whitespace-nowrap">
