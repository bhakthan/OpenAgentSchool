...
export const pageSEOConfigs = {
  ...
  '/ai-skills': {
    title: 'AI-Native Skills Explorer - Frontier Firm Assessment & Development Velocity | Open Agent School',
    description: 'Comprehensive AI-native skills development platform covering enterprise transformation methodologies and practical implementation frameworks. Features Frontier Firm Assessment (organizational AI maturity evaluation using 50+ criteria across technology adoption, cultural readiness, skill development, and strategic alignment), AI Ratio Calculator (measuring ROI through productivity gains, cost savings, efficiency improvements, and value creation metrics), Development Velocity Optimization (AI-accelerated engineering practices including intelligent code generation, automated testing, AI-powered code review, continuous integration enhancement, and team productivity measurement), Cross-Team Collaboration Frameworks (coordination strategies, communication protocols, knowledge sharing systems, and collaborative AI development practices), Novel Practice Patterns (emerging AI-native methodologies including AI-first design thinking, automated decision frameworks, intelligent workflow orchestration, adaptive organizational structures, and next-generation AI practices), AI-Native Transformation (comprehensive change management, cultural shifts, technology adoption strategies, skill development programs, and strategic planning for AI-first enterprises), AI Productivity Metrics (performance measurement frameworks, impact tracking systems, efficiency analysis, and organizational value assessment), and Collaborative AI Frameworks (team-centric development, shared practices, model collaboration, and coordination strategies). Each section includes assessment tools, implementation guides, measurement frameworks, and real-world case studies.',
    keywords: 'AI-native skills, Frontier Firm assessment, AI ratio calculator, development velocity, cross-team collaboration, AI-native practices, novel practice patterns, AI transformation, AI-first organizations, AI ROI measurement, organizational AI maturity, AI-native development, AI productivity metrics, collaborative AI frameworks, enterprise AI adoption, AI assessment tools, productivity optimization, team collaboration, AI culture transformation, change management, strategic AI planning'
  },
