...
export const pageSEOConfigs = {
  ...
  '/agents-for-science': {
    ...
    description: 'Discover how multi-agent AI systems accelerate scientific breakthroughs through DeepEvolve: combining AlphaEvolve (iterative hypothesis exploration with LLM-driven generation and evolutionary selection) and Deep Research (automated literature synthesis with multi-agent coordination). Learn how agentic AI compresses years of research into weeks through combinatorial exploration, evidence-grounded hypothesis generation, and intelligent literature synthesis. Explore real-world applications in materials discovery (superconductors, catalysts, battery materials), drug discovery (novel compounds, drug repurposing, clinical trials), climate science (carbon capture, intervention strategies, ecosystem modeling), protein engineering (enzyme design, stability optimization, industrial applications), genomics (gene editing, sequencing analysis, therapeutic targets), astronomy (exoplanet detection, cosmological modeling, data analysis), quantum computing (algorithm development, error correction, optimization), neuroscience (brain mapping, neural networks, disease modeling), and renewable energy (solar cell optimization, energy storage, grid management). Features 10x faster discovery timelines, exponential hypothesis exploration, automated literature review processing thousands of papers daily, cross-domain knowledge transfer, and comprehensive evidence chains. Includes interactive visualizations of hypothesis evolution, agent workflows, and research synthesis processes. Based on arXiv:2510.06056 and production implementations at leading research institutions.',
    keywords: 'agents for science, AI scientific discovery, DeepEvolve, AlphaEvolve, Deep Research, multi-agent systems, hypothesis generation, automated literature review, research acceleration, materials discovery, drug discovery, protein engineering, climate science, genomics research, astronomy AI, quantum computing, neuroscience AI, renewable energy, scientific AI, research automation, AI-powered research, combinatorial discovery, evolutionary algorithms, knowledge synthesis, evidence-grounded research, research agents, scientific breakthroughs, AI research tools, laboratory automation, computational research, intelligent research systems',
    image: DEFAULT_SEO.image,
    type: 'article' as const
  },
  '/concepts': {
    title: 'Core Concepts - AI Agent Fundamentals | Open Agent School',
    description: 'Master 49 fundamental AI agent concepts through interactive visualizations and hands-on learning. Core concepts include: AI Agents (autonomous software systems), Agent Architecture (design patterns and components), Multi-Agent Systems (coordination and collaboration), Agent Security (protection and validation), Model Context Protocol (MCP for secure tool integration), Agent-to-Agent Communication (A2A protocols), Agent Communication Protocol (ACP for interoperability), Agent Orchestration (coordination patterns), Agent Tools (external integrations), Agent Memory (context management), Agent Planning (goal-directed behavior), Agent Reasoning (decision-making processes), Agent Learning (adaptation mechanisms), Agent Evaluation (performance assessment), Agent Safety (risk mitigation), Agent Governance (compliance and oversight), Human-Agent Interaction (collaboration interfaces), Agent Deployment (production strategies), Agent Monitoring (observability), Agent Scaling (performance optimization), Agent Integration (enterprise systems), Agentic AI Design Taxonomy (comprehensive classification framework), Universal Commerce Protocol (UCP & AP2), and more. Each concept includes theoretical foundations, practical implementations, code examples, Azure integration patterns, and real-world use cases.',
    keywords: 'AI agent concepts, agent architecture, multi-agent systems, agent security, AI fundamentals, interactive learning, MCP, Model Context Protocol, A2A communication, agent orchestration, agent tools, agent memory, agent planning, agent reasoning, agent evaluation, agent safety, human-agent interaction, agent deployment, agent monitoring, agent scaling, Agentic AI Design Taxonomy, UCP, Universal Commerce Protocol'
  },
  ...
  '/concepts/edge-agent': {
    ...
    description: 'Master edge AI deployment for factory floors and industrial environments. Learn to move agents from cloud to edge with Microsoft Rho-Alpha VLA+, Google Gemini ER 1.5, IT/OT convergence, OPC-UA integration, real-time guarantees, and production-grade safety patterns. Covers edge fundamentals, latency tiers, hardware selection (NVIDIA Jetson, Azure Stack Edge), quantization, industrial protocols (OPC-UA, Modbus, PROFINET), hybrid edge-cloud architectures, graceful degradation, federated learning, OTA updates, fleet management, and safety-critical guardrails.',
    keywords: 'edge AI, edge agent, industrial AI, IT/OT convergence, OPC-UA, factory automation, real-time AI, Microsoft Rho-Alpha, Gemini ER 1.5, VLA+, physical AI, NVIDIA Jetson, Azure Stack Edge, edge deployment, industrial protocols, Modbus, PROFINET, manufacturing AI, robotics edge, hybrid edge cloud, federated learning, OTA updates, fleet management'
  },
  ...
  '/concepts/xyz-claw': {
    title: 'XYZ-Claw: Multi-Agent Orchestration - End-to-End Swarm Architecture | Open Agent School',
    description: 'Master multi-agent orchestration with XYZ-Claw: supervisor-worker topology, async message passing, back-pressure, dead-letter queues, actor model, fan-out/fan-in pipelines, and systems thinking. Implementations in TypeScript, Go, and Rust.',
    keywords: 'xyz-claw, multi-agent orchestration, swarm architecture, supervisor worker, async message passing, actor model, back-pressure, dead-letter queue, fan-out fan-in, systems thinking, TinyClaw, PicoClaw, Moltis, OpenClaw'
  },
  '/concepts/ai-product-framework': {
    title: 'AI Product Framework: 8 Pillars for Trust-Centric Design | Open Agent School',
    description: 'Master the comprehensive AI Product Framework with 8 trust-centric pillars for building successful AI products from a Product Manager perspective. Learn actionable methodologies including: Trust Engineering System (quantifying user trust through confidence calibration, failure playbooks, and trust decay monitoring), Memory Governance Framework (ethical data retention, user-controlled memory settings, and regulatory compliance), Integration Stewardship (treating integrations as strategic decisions with least-privilege access and cost-to-value scoring), Capability Prioritization Matrix (focusing on end-to-end problem solving with dependency mapping and feature bloat prevention), Human-AI Synergy Design (context-preserving handoffs and role boundary definitions), Failure Resilience Architecture (designing for expected failures with recovery patterns and edge case handling), Ethical Compliance Layer (bias detection, regulatory impact assessments, and audit trail requirements), and Complexity Governance Model (treating complexity as a cost center with technical debt scoring and scalability thresholds). Each pillar includes concrete actions, measurable outcomes, business impact analysis, and real-world case studies demonstrating implementation success. Features interactive D3 tree visualization, detailed case studies from healthcare, e-commerce, fintech, enterprise SaaS, telecom, IoT, recruitment, and airlines. Learn how to drive adoption, reduce risk, prevent regulatory fines, optimize costs, and achieve production velocity through systematic trust-centric product development.',
    keywords: 'AI product framework, trust-centric design, AI product management, trust engineering, memory governance, integration stewardship, capability prioritization, human-AI synergy, failure resilience, ethical compliance, complexity governance, AI product development, AI trust metrics, AI governance, responsible AI products, AI product strategy, product manager AI, AI product design, trust calibration, AI reliability, AI product pillars, case studies, AI ROI, AI risk management, AI compliance, AI product best practices'
  },
  '/concepts/mcp': {
