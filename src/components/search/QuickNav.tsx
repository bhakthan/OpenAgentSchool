...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'c-agent-harness-engineering',       title: 'Agent Harness Engineering',        path: '/concepts/agent-harness-engineering',       keywords: 'harness situatedness sovereignty stakes state governance grounding', section: 'Concepts', icon: <Gear size={ICON_SIZE} /> },
